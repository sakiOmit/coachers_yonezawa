...
from .geometry import get_bbox, resolve_absolute_coords, yaml_str
...
from .scoring import compute_grouping_score, structure_hash, structure_similarity
...
# ---------------------------------------------------------------------------
# Stage A detectors (proximity / pattern / spacing / semantic / header-footer / zone)
# ---------------------------------------------------------------------------
